...
using BusStationCRM.Mail.Interfaces;
...
namespace BusStationCRM.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            else
            {
                ...
                //var birthDate = info.Principal.HasClaim(c => c.Type == ClaimTypes.DateOfBirth) ? info.Principal.FindFirstValue(ClaimTypes.DateOfBirth) : Input.BirthDate; 
